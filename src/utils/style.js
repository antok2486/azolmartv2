...
export const style =  StyleSheet.create({
    ...
    headerInputFilter: { width:262, height:42, borderWidth: 0, borderRadius: 10, borderColor: '#dee2e6', backgroundColor: '#fff', paddingEnd:26 },
    headerButtonSearch: { position:'absolute', right:12 },
